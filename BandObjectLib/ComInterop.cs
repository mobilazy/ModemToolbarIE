...
namespace BandObjectLib
{
	...
	public interface IPersistStream:IPersist  //IPersist is added
	{
		new void GetClassID(out Guid pClassID); //new keyword is added

        [PreserveSig] //new added from IETlbEnginer
        void IsDirty ();

		//void Load ([In, MarshalAs(UnmanagedType.Interface)] Object pStm);
        void Load([In] System.Runtime.InteropServices.ComTypes.IStream pStm); //this line is from IEtlbenginer

        //     void Save ([In, MarshalAs(UnmanagedType.Interface)] Object pStm,
        //[In] bool fClearDirty);

        void Save([In] System.Runtime.InteropServices.ComTypes.IStream pStm, //these two lines are from IEtlbeng
