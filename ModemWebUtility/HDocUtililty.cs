...
namespace ModemWebUtility
{
    public static class HDocUtility
    {
        ...
        public static string UrlDocregUpload = @"http://norwayappsprd.corp.halliburton.com/pls/log_web/docreg.upload";


        private static Encoding EncodingUnicode = Encoding.Unicode; // Encoding.GetEncoding("UTF-8");
        private static Encoding EncodingAscii = Encoding.ASCII;
        ...
        public static string GetOneFromListValueOfInputsByName(string name, HtmlAgilityPack.HtmlDocument hDoc)
        {
            ...
            List<string> temp = GetValueListOfInputsByName(name, hDoc);
        ...
        public static string GetTextAreaByName(string name, HtmlAgilityPack.HtmlDocument hDoc)
        {
            ...
            try
            {
                value1 = hDoc.DocumentNode.SelectSingleNode("//textarea[@name='" + name + "']")
                             .Attributes["value"].Value;
            }
            catch (NullReferenceException)
            {
